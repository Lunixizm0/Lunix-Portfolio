...
import { MusaitlikConfig } from "../../utils/musaitlik";
...
const ProfileCard: React.FC<Props> = ({ cfg }) => (
  <>
    <ProfileHeader>
      <ProfileName>{cfg?.kisi?.ad || ""}</ProfileName>
      <ProfileBio>{cfg?.kisi?.unvan || ""}</ProfileBio>
    </ProfileHeader>
